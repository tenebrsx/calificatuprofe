...
const DEPARTMENTS = ['Ingeniería', 'Medicina', 'Administración', 'Derecho', 'Psicología', 'Arquitectura']
const INSTITUTIONS = ['INTEC', 'PUCMM', 'UASD', 'UNPHU']
            ...
            {filteredResults.map((professor) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`w-12 h-12 rounded-full ${getRatingColor(professor.rating)} flex items-center justify-center flex-shrink-0`}>
