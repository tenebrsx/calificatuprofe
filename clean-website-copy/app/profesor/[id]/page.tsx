    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div id="hero-section" className="mb-12">
          <div className="flex items-start gap-12 mb-8">
            ...
            <div className="flex flex-col items-center">
              <div className={`w-36 h-36 rounded-2xl ${getRatingColor(professor.averageRating)} flex flex-col items-center justify-center mb-3 shadow-lg`}>
          ...
          <div className="text-center">
              <div className="text-5xl font-bold text-gray-900 mb-2 metric-number">{professor.wouldTakeAgainPercent}%</div>
              <p className="text-lg text-gray-600">Tomaría de nuevo</p>
            </div>
            <div className="text-center border-x border-gray-200">
              <div className="text-5xl font-bold text-gray-900 mb-2 metric-number">{professor.difficultyRating.toFixed(1)}</div>
              <p className="text-lg text-gray-600">Nivel de dificultad</p>
          </div>
          <div className="text-center">
              ...
              <p className="text-lg text-gray-600">Recomendación general</p>
        </div>
      </div>
        ...
        {session ? (
          ...
          >
                Calificar a {professor.name.split(' ')[0]}
          </button>
        ) : (
          <Link
            href="/auth/signin"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Left Column - Rating Distribution and Tags */}
          <div className="lg:col-span-1 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  { name: 'Dr. María Santos', rating: 4.8, department: 'Ingeniería', id: '2' },
                  { name: 'Prof. Carlos López', rating: 4.6, department: 'Ingeniería', id: '3' },
                  { name: 'Dra. Ana Méndez', rating: 4.5, department: 'Ingeniería', id: '4' }
                ].map((similarProf) => (
                  <Link
                    key={similarProf.id}
      ...
      <div>
                    ...
                    <div className={`px-3 py-1 rounded-lg text-white font-bold ${getRatingColor(similarProf.rating)}`}>
