...
const MOCK_RESULTS: SearchResult[] = [
  {
    ...
    type: 'professor',
    name: 'Dr. Juan Pérez',
    subtitle: 'Ingeniería de Sistemas • INTEC',
    rating: 4.5,
    totalRatings: 25,
    tags: ['CLARO AL EXPLICAR', 'EXÁMENES JUSTOS', 'INSPIRADOR'],
    description: 'Profesor destacado en programación y algoritmos. Conocido por su metodología práctica y exámenes bien estructurados.'
  },
  {
    id: '2',
    type: 'professor',
    name: 'Dra. María González',
    subtitle: 'Medicina • UNPHU',
    rating: 4.8,
    totalRatings: 42,
    tags: ['INSPIRADOR', 'DISPONIBLE PARA AYUDAR', 'EXÁMENES JUSTOS'],
    description: 'Especialista en cardiología con amplia experiencia docente. Muy apreciada por su dedicación a los estudiantes.'
  },
  {
    id: '3',
    type: 'professor',
    name: 'Dr. Carlos Rodríguez',
    subtitle: 'Matemáticas • UASD',
    rating: 4.2,
    totalRatings: 18,
    tags: ['CLARO AL EXPLICAR', 'TAREAS ÚTILES', 'CALIFICACIÓN ESTRICTA'],
    description: 'Profesor de cálculo y álgebra lineal. Exigente pero justo, con metodología clara y bien estructurada.'
  },
  {
    id: '4',
    type: 'university',
    name: 'INTEC',
    subtitle: 'Instituto Tecnológico de Santo Domingo',
    description: 'Universidad líder en tecnología e ingeniería en República Dominicana. 245 profesores registrados.'
  },
  {
    id: '5',
    type: 'department',
    name: 'Ingeniería de Sistemas',
    subtitle: 'INTEC • 45 profesores',
    description: 'Departamento enfocado en desarrollo de software, bases de datos, y sistemas de información.'
  }
]
                ...
                {results.length > 0 ? (
                  results.map((result) => (
                    <Link
                      key={result.id}
                      href={
                        result.type === 'professor' ? `/profesor/${result.id}` :
                        result.type === 'university' ? `/institucion/${result.id}` :
                        `/departamento/${result.id}`
                      }
                            ...
                            {result.rating && (
                              <div className="text-right">
                                ...
                                <p className="text-sm text-gray-500">
                                  {result.totalRatings} calificaciones
                                </p>
                              </div>
                            )}
                          </div>
